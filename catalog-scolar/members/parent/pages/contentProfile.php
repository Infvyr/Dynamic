 ...
 if (!$res) {
    die('Date eronate' . mysqli_error());
      ...
      echo "<script>
            ...
            setTimeout(function() { window.location.href = 'http://localhost/catalog-scolar/members/parent/profile.php';}, 2000);
      </script>";
  }
  mysqli_close($db);
} 
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <tr>
                  <td class="text-info"><strong>Nume</strong></td>
                  <td>'.$row["user_name"].'</td>
                </tr>
                <tr>
                  <td class="text-info"><strong>Copil</strong></td>
                  <td>'.$row["user_child"].'</td>
                </tr>
                <tr>
