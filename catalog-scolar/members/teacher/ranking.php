<?php 
session_start(); 
$title = "Statistică - clasament clase la absențe note";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="ranking.php"><i class="fa fa-dashboard"></i><strong>Clasament clase</strong></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box-header with-border bg-green content-title">
            <h3 class="box-title">Clasament clase</h3>
        </div>
